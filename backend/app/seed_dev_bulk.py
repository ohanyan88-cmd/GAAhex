...
CUSTOMERS = [
    ...
    ("Սարգսյան Լիլիթ Արմենի",      "individual",   "lilit.sargsyan@example.am",      "+374 99 201004", "Pro",      "Մալաթիա-Սեբաստիա",   "Շիրազի 64",      "residential"),
...
EMPLOYEES = [
    ...
    ("Ավետիսյան Աննա Գագիկի",   "anna.avetisyan@gaahex.am",   "Helpdesk Lead"),
...
_QUOTES = [
    ("QUO-000101", "SENT",     4500000,  "Հակոբյան Արամ Սարգսի"),
    ("QUO-000102", "SENT",     25000000, "Tumo Center"),
    ("QUO-000103", "SENT",     1200000,  "Erebuni IT Solutions"),
    ("QUO-000104", "ACCEPTED", 800000,   "Սարգսյան Լիլիթ Արմենի"),
    ("QUO-000105", "DRAFT",    1500000,  "Գրիգորյան Մարիամ Վահանի"),
]
