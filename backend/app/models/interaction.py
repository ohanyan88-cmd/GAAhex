...
class Interaction(Base):
    ...
    # Canonical CommunicationChannel (standard 14, 8 UPPER_SNAKE values):
    #   WHATSAPP|MESSENGER|SMS|EMAIL|CALLS|INTERNAL_CHAT|PORTAL_MESSAGE|SYSTEM_MESSAGE
    channel: Mapped[str] = mapped_column(String(20), nullable=False)
    # Canonical CommunicationDirection (standard 14, 4 UPPER_SNAKE values):
