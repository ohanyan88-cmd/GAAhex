...
ENTITY_CATALOG = [
    ...
    e("sales_channel", "Sales Channel", "Sales Channels", "sales-channels", "building",
      [f("name", "Name", "text", True), f("type", "Type", "select", options=["direct", "reseller", "online", "retail"]),
       f("manager", "Manager", "ref", target="user"), f("region", "Region", "text")],
      [st("ACTIVE", "Active", True), st("INACTIVE", "Inactive")], [tr("ACTIVE", "INACTIVE"), tr("INACTIVE", "ACTIVE")]),
    ...
    e("tariff_plan", "Tariff Plan", "Tariff Plans", "tariff-plans", "bookmark",
      [f("name", "Name", "text", True), f("description", "Description", "textarea"),
       f("price", "Monthly Price", "money"), f("speed_down", "Speed Down (Mbps)", "number"),
       f("speed_up", "Speed Up (Mbps)", "number"), f("data_cap", "Data Cap (GB)", "number")],
    ...
    e("collection_case", "Collection Case", "Collections", "collections", "inbox",
      [f("customer", "Customer", "ref", target="customer"), f("amount_due", "Amount Due", "money"),
       f("reason", "Reason", "text"), f("assigned_to", "Assigned To", "ref", target="user")],
      [st("OPEN", "Open", True), st("RESOLVED", "Resolved"), st("WRITTEN_OFF", "Written Off")],
      [tr("OPEN", "RESOLVED"), tr("OPEN", "WRITTEN_OFF")]),
