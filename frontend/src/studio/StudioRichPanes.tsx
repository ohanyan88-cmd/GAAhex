...
// ── 12  ENTITY BUILDER  (removed) ─────────────────────────────────────────────
//
// The local-state EntityBuilder (with an inert "Create entity" button) was
// removed when Module 2 shipped. The Entities leaf is now wired to the real
// backend via `EntitiesPane` (see StudioGenericPane: REAL_PANE_BY_LEAF_ID
// ['data.models.entities']). Per doctrine: delete old code, don't layer it.
