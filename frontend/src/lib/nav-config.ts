...
export const NAV_SECTIONS: NavSectionDef[] = [
  ...
  s('workspace', 'Workspace', HomeIcon, [
    ...
    i('ws-global-search',  'Global Search',    InboxIcon,      undefined,                          undefined, 'V'),
    ...
    i('ws-recent',         'Recent Items',     ClockIcon,      undefined,                          undefined, 'V'),
    i('ws-team',           'Team Workspace',   UsersIcon,      undefined,                          undefined, 'V'),
  ...
  s('network_operations', 'Network & Operations', ServerIcon, [
    ...
    i('net-coverage',          'Coverage & GIS',         ServerIcon,     undefined,                             undefined, 'O'),
    i('net-topology',          'Network Topology',       ServerIcon,     undefined,                             undefined, 'V'),
    i('net-provisioning',      'Provisioning',           GearIcon,       undefined,                             undefined, 'V'),
