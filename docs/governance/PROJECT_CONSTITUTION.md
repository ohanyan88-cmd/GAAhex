...
| 3 | 2026-06-06 | Gev | **Prefix Registry Reconciliation — APPLIED.** Resolves 8 prefix conflicts (CNT/CMP/APP/CTR/PLN/SVC-SUB/WBH-WHK/SVA-SAC), backfills entities into IA8 §8 (Lead/Role/Configuration/FeatureFlag/Department prefix/Team prefix/Location-parent/NetworkDevice-parent/PurchaseOrder/Project/Campaign/CaseQueue prefix/Release/DomainEvent prefix), expands Std03 registry from 40 → 99 canonical prefixes. Standard 03 becomes the single authoritative prefix registry; IA8 §7.4 mirrors. Canonical mappings: `CNX-` Connector, `EPL-` EntitlementPlan, `SUB-` Subscription, `SVC-` ServiceInstance, `SAC-` ServiceAccount, `SVA-` ServiceArea. Deprecated alias: `WBH-` → `WHK-`. Zero remaining prefix conflicts after validation. |
