---
name: gaaex-design
description: Use this skill to generate well-branded interfaces and assets for GAAex — the multi-tenant, config-driven operations platform for ISPs — either for production or throwaway prototypes/mocks. Contains essential design guidelines, colors, type, fonts, logo assets, and a full UI kit of console components (sidebar, top bar, KPI tiles, data tables, status pills, Studio).
user-invocable: true
---

Read the `README.md` file in this skill first — it covers GAAex's product context, content voice,
...
Mono. Icons are Lucide (2px stroke). No emoji in product UI. Remember GAAex is config-driven —
